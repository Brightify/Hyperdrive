...
class StreamEventSerializer<DATA>(
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor("org.brightify.hyperdrive.krpc.protocol.ascension.StreamEvent") {
        element("type", eventTypeSerialier.descriptor)
        element("content", isOptional = true, descriptor = buildSerialDescriptor("org.brightify.hyperdrive.krpc.protocol.ascension.StreamEvent.content", kind = SerialKind.CONTEXTUAL) { })
    }
