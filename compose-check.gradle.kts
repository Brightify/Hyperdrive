buildscript {
    ...
    val isProbablySupportingJetpackCompose: Boolean = true || extra.properties.containsKey("enableCompose") || extra.properties.containsKey("forceEnableCompose") || androidStudioVersionSuffixes.any {
